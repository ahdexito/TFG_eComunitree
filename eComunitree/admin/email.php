        ...
        $mail->Body = "
            <div style='font-family: Arial, sans-serif; border: 1px solid #ddd; padding: 20px; border-radius: 10px; max-width: 600px;'>
                ...
                <div style='text-align: center;'>
                    <a href='https://bit.ly/4tKjZF2' style='background-color: #4042be; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; display: inline-block;'>Ver publicación completa</a>
                </div>
            </div>";
